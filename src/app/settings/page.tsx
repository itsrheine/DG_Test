    ...
    <main
      ...
      <div className="mx-auto max-w-md px-4 pt-8">
        ...
        <SettingsCard theme={theme}>
          <SettingsRow label="Profile" value="Inspector Info" theme={theme} />
          <SettingsRow label="Company" value="Branding" theme={theme} />
          <SettingsRow label="Report Header" value="Default" theme={theme} />
          <SettingsRow label="Footer Note" value="Default" theme={theme} />
        </SettingsCard>
        ...
        <SettingsCard theme={theme}>
          ...
          <SettingsRow label="Notifications" value="Off" theme={theme} />
          <SettingsRow label="Billing" value="Coming Soon" theme={theme} />
        </SettingsCard>
